...
`phern daemon` was **denied**, not because a person said no but because nobody could
...
watch one session — a terminal, a browser tab, `phern agents attach` — and each has
