...
class DaemonSession:
    ...
    **A constructor argument rather than a setter**, for the reason
    ...
    def _unread(self, message: str, *args: object) -> None:
...
async def attach_session(
    ...
    *,
    ...
    # happens when somebody opens a screen. `phern agents attach` builds the same
    # shape for `--since`.
...
def _remote_command(
    ...
    async def elsewhere(argument: str, _context: object) -> str | None:
