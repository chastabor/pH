...
UNBOUND: dict[str, str] = {
    ...
    "IntentKind.reconciled": "a pure payload from a record and an answer; repair calls it "
    "with nothing mounted",
    "IntentKind.within": "a pure read of a record; repair calls it with nothing mounted",
